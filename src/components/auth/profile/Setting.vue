        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <br><br>
                    <form class="form-horizontal">
                        <input type="text" class="form-control" id="keywords" placeholder="Like #movies #kittens #travel #teacher #newyork" v-model=bio>
                    </form>
                </div>
            </div>
            <div class="panel panel-default">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form class="form-horizontal">
                        ...
                        <input type="text" class="form-control" id="Your_location" placeholder="Fill me out" v-model=location>
                        <br>
